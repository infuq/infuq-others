...
static void start_process(void *func)
{
    ...
    struct intr_stack *proc_intr_stack = (struct intr_stack *) cur->self_kstack;
    proc_intr_stack->edi     = proc_intr_stack->esi = proc_intr_stack->ebp = proc_intr_stack->esp_dummy = 0;
    proc_intr_stack->ebx     = proc_intr_stack->edx = proc_intr_stack->ecx = proc_intr_stack->eax = 0;
...
static uint32_t *create_page_dir()
{
