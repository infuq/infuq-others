      ...
      <div style="margin-top: 25px;">
        ...
        <el-form label-width="100px" class="demo-ruleForm">
          <div>
            ...
            <el-input type="textarea" placeholder="请输入JSON内容" v-model="json_content"
          ...
          <div
              style="margin-top: 15px; border: 1px solid #eae3e3; padding: 10px; background: aliceblue; overflow: auto;"
              v-if="show_format_result">
